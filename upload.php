    ...
    <div class="row">
      <div class="col-md-6 col-md-offset-3">
        ...
        <!-- <form class="form-horizontal" method="post" enctype="multipart/form-data">
          <div class="form-group">
            <div class="col-md-10">
              <input type="file" multiple name="myFile" class="filestyle" data-icon="false">
            </div>
            <div class="col-md-2">
        ...
        if (!empty($_FILES["myFile"])) {
          ...
          if ($myFile["error"] !== UPLOAD_ERR_OK) {
            echo '<br><br><br><br><div class="alert alert-warning">Gagal upload file.</div>';
            exit;
          }
          ...
          if (!$success) { 
            ...
            if($insert){
              echo '<br><br><br><br><div class="alert alert-success">File berhasil di upload.</div>';
            }else{
              echo '<br><br><br><br><div class="alert alert-warning">Gagal upload file.</div>';
              exit;
            }
